...
public class 改良后的Producer {
    private static final String brokerList = "localhost:9092";
    private static final String topic = "cs";
    ...
    public static Properties initNewConfig() {
        ...
        // 自定义拦截器使用
        props.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, 自定义生产者拦截器.class.getName());
